...
const ministeriosCompletos = [
    ...
    { nombre: 'Ministerio de Varones', descripcion: 'Formación bíblica y doctrinal para todas las edades.', encargado: 'Pr. Raúl Laguna', icono: 'bi-book', categoria: 'general' },
    { nombre: 'Ministerio de Damas', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Nena García', icono: 'bi-heart', categoria: 'general' },
    { nombre: 'Ministerio de Jóvenes', descripcion: 'Formación bíblica y doctrinal para todas las edades.', encargado: 'Erwin Mena y Pía Hernandez', icono: 'bi-people', categoria: 'general' },
    { nombre: 'Ministerio Infantil', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Nena Garcia', icono: 'bi-star', categoria: 'general' },
    ...
    { nombre: 'Ministerio de Misiones y evangelismo', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'N/A', icono: 'bi-globe', categoria: 'general' },
    ...
    { nombre: 'Ministerio de Biblioteca', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Marcelo Canales', icono: 'bi-book-half', categoria: 'general' },
    { nombre: 'Ministerio de Audiovisual', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Marcelo Miranda', icono: 'bi-camera-video', categoria: 'general' },

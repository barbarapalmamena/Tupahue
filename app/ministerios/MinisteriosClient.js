        ...
        async function loadMinisterios() {
            ...
            if (data && data.length > 0) {
                ...
                setMinisterios([
                    ...
                    { id: 4, nombre: 'Ministerio de Matrimonios', descripcion: 'Un espacio de encuentro y crecimiento espiritual para los matrimonios.', encargado: 'Pr. Raul y Nena', icono: 'bi-heart', categoria: 'general' },
                    { id: 5, nombre: 'Ministerio de Varones', descripcion: 'Formación bíblica y doctrinal para todas las edades.', encargado: 'Rafael Guaran', icono: 'bi-book', categoria: 'general' },
                    { id: 6, nombre: 'Ministerio de Damas', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Nena', icono: 'bi-heart', categoria: 'general' },
                    { id: 7, nombre: 'Ministerio de Jóvenes', descripcion: 'Formación bíblica y doctrinal para todas las edades.', encargado: 'Carlos y Maria Jesus', icono: 'bi-people', categoria: 'general' },
                    { id: 8, nombre: 'Ministerio Infantil', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Nena', icono: 'bi-star', categoria: 'general' },
                    ...
                    { id: 12, nombre: 'Ministerio de Misiones y evangelismo', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Rodrigo Cardenas', icono: 'bi-globe', categoria: 'general' },
                    ...
                    { id: 14, nombre: 'Ministerio de Biblioteca', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Carolina Santibañez', icono: 'bi-book-half', categoria: 'general' },
                    { id: 15, nombre: 'Ministerio de Audiovisual', descripcion: 'Ayuda social y apoyo comunitario, reflejando el amor de Cristo.', encargado: 'Marcelo', icono: 'bi-camera-video', categoria: 'general' },
